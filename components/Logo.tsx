...
const Logo: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <div className={`flex items-center gap-2 select-none ${className}`}>
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 drop-shadow-md">
      ...
      <span className="font-display font-bold text-lg md:text-xl tracking-tight drop-shadow-sm">
        Flopcoast
      </span>
    </div>
  );
